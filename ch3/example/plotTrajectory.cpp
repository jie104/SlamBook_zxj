...
std::string trajectory_file="/home/zxj/桌面/Study/SlamBook_zxj/ch3/example/trajectory.txt";

void DrawTracjectory(std::vector<Eigen::Isometry3d,
...
int main(int argc,char **argv){
    ...
    if(!fin){
        std::cout << "cannot find tracjectory file at " << trajectory_file << std::endl;
        return 1;
    }
    ...
    std::cout << "real total " << poses.size() << " pose entries" << std::endl;

    //draw trajectroy in pangolin
    DrawTracjectory(poses);
    return 0;
