...
// global variables
string first_file = "/home/zxj/桌面/Study/SlamBook_zxj/ch7/1.png";
string second_file = "/home/zxj/桌面/Study/SlamBook_zxj/ch7/2.png";
  ...
  for (auto &kp: keypoints) {   //舍弃图像边界点
    ...
    for (int dx = -half_patch_size; dx < half_patch_size; ++dx) {
      for (int dy = -half_patch_size; dy < half_patch_size; ++dy) {
        uchar pixel = img.at<uchar>(kp.pt.y + dy, kp.pt.x + dx);//灰度值
        m10 += dx * pixel;
        m01 += dy * pixel;
      }
    }
